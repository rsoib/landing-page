<div class="wrapper container-fluid">
	{!! Form::open(['url'=>route('portfolioEdit',array('portfolio'=>$data['id'])), 'class'=>'form-horizontal','method'=>'POST','enctype'=>'multipart/form-data']) !!}
		...
		<div class="form-group">
			...
			<div class="col-xs-4">
				{!! Form::text('filter',$data['filter'],['class'=>'form-control','placeholder'=>'Введите категорию']) !!}
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-offset-2 col-xs-10 ">
				{!! Html::image('assets/img/'.$data['images'],'', ['class'=>'img-circle delay-03s animated wow zoomIn', 'width'=>'200px']) !!}
